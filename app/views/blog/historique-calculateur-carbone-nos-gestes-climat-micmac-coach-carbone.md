...
Rappelons-le : l'objectif est de proposer des ordres de grandeurs, simplement et rapidement, sans poser un trop grand nombre de questions. Parmi les nombreux retours, certains soulignent qu'ils seraient intéressant de préciser si son fournisseur d'électricité est vert, le type de carburant utilisé, etc. Les calculateurs sont perfectibles dans quelques cas limités (et seront améliorés grâce à tous les retours). Mais la perspective d'un bilan au gramme de CO<sub>2</sub>e près est tentante mais illusoire. Bien avant cela, connaître les grands ordres de grandeurs, comparer les catégories d'émissions entre elles, etc. apporte déjà une compréhension de la baisse à effectuer et des actions nécessaires à mettre en oeuvre dans la durée face à nos engagements face aux enjeux climatiques.
Si l'on veut toucher largement les citoyens avec ce type de calculateur, il ne s'agit donc pas de rentrer dans un niveau de détails trop grand qui nécessiterait bien trop de questions et ennuierait de nombreux utilisateurs qui quitterraient la simulation. Non, l'objectif reste bien de permettre de se rendre compte où il est important d'agir dans sa situation, et de donner des premières pistes chiffrées pour ce faire.
